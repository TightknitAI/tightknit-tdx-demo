...
export default SlackFunction(
  ...
  async ({ inputs, client }) => {
    ...
    const blocks = [
      {
        ...
        text: {
          type: "mrkdwn",
          text: "Do you want to generate a new Salesforce Knowledge article based on the results of this conversation?",
        },
      },
      {
        type: "actions",
    ...
    const msgResponse = await client.chat.postMessage({
      ...
      text: "Do you want to generate a new Salesforce Knowledge article based on this conversation?",
      icon_emoji: ":sparkles:",
    });
      ...
      blocks: [
        {
          ...
          text: {
            type: "mrkdwn",
            text: "Do you want to create a draft of this article in Salesforce Knowledge?",
          },
        },
        {
          type: "actions",
